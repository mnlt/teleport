...
def cmd_scan(args: argparse.Namespace) -> int:
    ...
    if not plan:
        console.print("  [dim]no MCPs detected.[/dim]")
        console.print()
        console.print("  [dim]install one first, e.g.:[/dim]")
        console.print("    [magenta]claude mcp add --transport http notion https://mcp.notion.com/mcp[/magenta]")
        console.print()
        console.print("  [dim]then run[/dim] [magenta]teleport-setup[/magenta] [dim]to migrate.[/dim]")
        console.print()
        return 0
